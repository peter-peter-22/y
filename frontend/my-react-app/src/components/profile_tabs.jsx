...
function MediaOfUser({ user }) {
    ...
    return (
        <OnlineList getEntries={GetEntries} entryMapController={Container} key={user.id} fromCol="id"/>
    );
}
...
function Followers({ user }) {
    return (
        <Stack direction="column">
            ...
            <UserListExtended url={"member/general/followers_of_user"} params={{ id: user.id }} fromCol="follow_id"/>
        </Stack>
    );
}
...
function Following({ user }) {
    return (
        <Stack direction="column">
            ...
            <UserListExtended url={"member/general/followed_by_user"} params={{ id: user.id }} fromCol="follow_id"/>
        </Stack>
    );
}
